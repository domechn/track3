...
fn move_data_from_assets_to_v2(data: Vec<AssetsV1>) -> Vec<AssetsV2> {
    ...
    for row in data {
        ...
        let data1 = asset_v1_model_to_v2(
            uuid.to_string(),
            ca.clone(),
            row.top01,
            row.amount01,
        ...
        let data2 = asset_v1_model_to_v2(
            uuid.to_string(),
            ca.clone(),
            row.top02,
            row.amount02,
        ...
        let data3 = asset_v1_model_to_v2(
            uuid.to_string(),
            ca.clone(),
            row.top03,
            row.amount03,
        ...
        let data4 = asset_v1_model_to_v2(
            uuid.to_string(),
            ca.clone(),
            row.top04,
            row.amount04,
        ...
        let data5 = asset_v1_model_to_v2(
            uuid.to_string(),
            ca.clone(),
            row.top05,
            row.amount05,
        ...
        let data6 = asset_v1_model_to_v2(
            uuid.to_string(),
            ca.clone(),
            row.top06,
            row.amount06,
        ...
        let data7 = asset_v1_model_to_v2(
            uuid.to_string(),
            ca.clone(),
            row.top07,
            row.amount07,
        ...
        let data8 = asset_v1_model_to_v2(
            uuid.to_string(),
            ca.clone(),
            row.top08,
            row.amount08,
        ...
        let data9 = asset_v1_model_to_v2(
            uuid.to_string(),
            ca.clone(),
            row.top09,
            row.amount09,
        ...
        let data10 = asset_v1_model_to_v2(
            uuid.to_string(),
            ca.clone(),
            row.top10,
            row.amount10,
